...
abstract class ThemesText {
  ...
  static final latoTextStyle = GoogleFonts.montserrat();
}

class DesktopTextTheme implements ThemesText {
  @override
  ...
  @override
  final paragraph20 = GoogleFonts.lato(fontSize: 20, fontWeight: FontWeight.normal);
  @override
  final paragraph18 = GoogleFonts.lato(fontSize: 18, fontWeight: FontWeight.normal);

  @override
  final body = GoogleFonts.lato(fontSize: 16, fontWeight: FontWeight.normal, height: 1.5);

  @override
  final subhead = GoogleFonts.lato(fontSize: 14, fontWeight: FontWeight.normal);
  @override
  final subheadAllCaps = GoogleFonts.lato(fontSize: 12, fontWeight: FontWeight.normal, letterSpacing: 2.5);

  @override
  final button = GoogleFonts.lato(fontSize: 14, fontWeight: FontWeight.bold);

  @override
  final footnote = GoogleFonts.lato(fontSize: 12, fontWeight: FontWeight.normal);
  @override
  final footnoteAllCaps = GoogleFonts.lato(fontSize: 12, fontWeight: FontWeight.normal, letterSpacing: 2.5);
}

class MobileTextTheme implements ThemesText {
  @override
  ...
  final subhead = GoogleFonts.lato(fontSize: 14, fontWeight: FontWeight.normal);
  @override
  final subheadAllCaps = GoogleFonts.lato(fontSize: 14, fontWeight: FontWeight.normal, letterSpacing: 2.5);
